...
const pl = {
  fixed: 'Naprawił',
  default: 'Domyślny',
  save_as_custom_field: 'Zapisz jako pole niestandardowe',
  kba: 'KBA',
  analyzing_: 'Analizuję...',
  download: 'Pobierać',
  downloading_: 'Ściąganie...',
  view: 'Pogląd',
  autodetect_fields: 'Automatyczne wykrywanie pól',
  payment_link: 'Link do płatności',
  strikeout: 'Przekreślenie',
  draw_strikethrough_the_document: 'Narysuj przekreślenie dokumentu',
  quantity: 'Ilość',
  prefillable: 'Możliwość wstępnego wypełnienia',
  signature_id: 'Podpis ID',
  ...
  uploaded_pdf_contains_form_fields_keep_or_remove_them: 'Przesłany PDF zawiera pola formularza. Zachować je czy usunąć?',
  keep: 'Trzymać',
  left: 'Lewy',
  heading: 'Nagłówek',
  ...
  type: 'Typ',
  list: 'lista',
  no_variables: 'Nie ma jeszcze zmiennych',
  no_variables_description: 'Dodaj znaczniki [[zmienna]] do swojego dokumentu, aby utworzyć zmienne zawartości dynamicznej.',
  ...
  sign_yourself: 'Podpisz się',
  set_signing_date: 'Ustaw datę podpisania',
  signing_date: 'Data podpisania',
  signing_date_and_time: 'Data i godzina podpisu',
  send: 'Wysłać',
  remove: 'Usunąć',
  edit: 'Redagować',
  settings: 'Ustawienia',
  ...
  any: 'Każdy',
  drawn: 'Pociągnięty',
  drawn_or_typed: 'Rysowane lub wpisywane na maszynie',
  drawn_or_upload: 'Narysuj lub prześlij',
  upload: 'Wgrywać',
  formula: 'Formuła',
  typed: 'Wpisane',
  draw_field_on_the_document: 'Narysuj pole na dokumencie',
  ...
  add_pdf_documents_or_images: 'Dodaj dokumenty lub obrazy PDF',
  add_documents_or_images: 'Dodaj dokumenty lub obrazy',
  add_a_new_document: 'Dodaj nowy dokument',
  edit_documents: 'Edytuj dokumenty',
  move_forward: 'Przenieś do przodu',
  move_backward: 'Przenieś w tył',
  remove_page: 'Usuń stronę',
  merge_with_previous: 'Połącz z poprzednią',
  merge_with_next: 'Połącz z następną',
  move_up: 'Przenieś w górę',
  move_down: 'Przenieś w dół',
  rotate: 'Obróć',
  redact: 'Redaguj',
  crop: 'Przytnij',
  crop_and_scan: 'Przytnij i skanuj',
  flip_horizontal: 'Odbij poziomo',
  flip_vertical: 'Odbij pionowo',
  there_is_no_text_to_redact_on_this_page: 'Ta strona zawiera tylko obrazy. Narzędzie redakcji może być używane tylko na stronach tekstowych',
  color: 'Kolor',
  reset: 'Resetuj',
  upload_to_document: 'Prześlij do "{document}"',
  replace_existing_document: 'Zastąp istniejący dokument',
  clone_and_replace_documents: 'Klonuj i zastępuj dokumenty',
  required: 'Wymagany',
  ...
  options: 'Opcje',
  condition: 'Stan',
  make_dynamic: 'Bądź dynamiczny',
  first_party: 'Pierwsza impreza',
  second_party: 'Druga strona',
  third_party: 'Strona trzecia',
  fourth_party: 'Czwarta Partia',
  fifth_party: 'Piąta Partia',
  sixth_party: 'Szósta Partia',
  seventh_party: 'Siódma partia',
  eighth_party: 'Ósma Partia',
  ninth_party: 'Dziewiąta impreza',
  tenth_party: 'Dziesiąta Partia',
  eleventh_party: 'Jedenasta impreza',
  twelfth_party: 'Dwunasta Partia',
  thirteenth_party: 'Partia Trzynasta',
  fourteenth_party: 'Partia Czternasta',
  fifteenth_party: 'Partia Piętnasta',
  sixteenth_party: 'Partia Szesnasta',
  seventeenth_party: 'Impreza siedemnasta',
  eighteenth_party: 'Impreza osiemnasta',
  nineteenth_party: 'Impreza XIX',
  twentieth_party: 'Dwudziesta impreza',
  draw: 'Rysować',
  add: 'Dodać',
  ...
  multiple_field: 'Wiele pól wyboru',
  radio_field: 'Pole Grupy Radiowej',
  cells_field: 'Pole komórek',
  stamp_field: 'Pole znaczków',
  payment_field: 'Pole płatności',
  phone_field: 'Pole Telefon',
  draw_a_text_field_on_the_page_with_a_mouse: 'Narysuj pole tekstowe na stronie za pomocą myszy',
  drag_and_drop_any_other_field_type_on_the_page: 'Przeciągnij i upuść dowolny inny typ pola na stronie',
  click_on_the_field_type_above_to_start_drawing_it: 'Kliknij typ pola powyżej, aby rozpocząć jego rysowanie',
  please_draw_fields_to_prepare_the_document: 'Proszę narysować pola w celu przygotowania dokumentu.',
  only_pdf_and_images_are_supported: 'Obsługiwane są tylko PDF i obrazy.',
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification: 'Odblokuj pole numeru telefonu zweryfikowanego przez SMS w ramach płatnego planu. Użyj pola tekstowego dla numerów telefonów bez weryfikacji.',
  ...
  connect_google_drive: 'Połącz Dysk Google',
  none: 'Nic',
  ssn: 'SSN',
  ein: 'EIN',
  email: 'E-mail',
  ...
  regexp_validation: 'Walidacja wyrażenia regularnego',
  custom_validation: 'Weryfikacja niestandardowa',
  length_validation: 'Walidacja długości',
  number_range: 'Zakres liczb',
  enter_pdf_password: 'Wprowadź hasło PDF',
  wrong_password: 'Błędne hasło',
  currency: 'Waluta',
  save_and_preview: 'Zapisz i wyświetl podgląd',
  preferences: 'Preferencje',
  available_in_pro: 'Dostępne w Pro',
  revisions: 'Wersje',
  no_revisions_yet: 'Brak wersji',
  viewing_revision_from: 'Wyświetlanie wersji z {date}',
